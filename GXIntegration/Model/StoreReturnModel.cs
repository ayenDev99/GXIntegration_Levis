...
namespace GXIntegration_Levis.Model
{
	public class StoreReturnModel
	{
		...
		public List<ReturnItems> ReturnItems { get; set; } = new List<ReturnItems>();
		public List<ReturnTender> ReturnTenders { get; set; } = new List<ReturnTender>();
	}
	...
	public class ReturnItems
	{
		...
		public List<ReturnDiscount> ReturnDiscounts { get; set; } = new List<ReturnDiscount>();
	}
