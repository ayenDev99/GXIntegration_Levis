				...
				try
				{
					...
					string sql = @"
								SELECT
									...
									, TRUNC(PO.CREATED_DATETIME)			AS BusinessDayDate
									, PO.CREATED_DATETIME					AS BeginDateTime
									, PO.POST_DATE							AS EndDateTime
									...
									, PO.MODIFIED_DATETIME			        AS CompletionTimestamp
									, PO.MODIFIED_DATETIME			        AS LastActivityTimestamp
									...
									, ''							        AS ExpectedCount
									, ''							        AS POSTEDCOUNT
									, PO.CREATED_DATETIME			        AS SaleLineBusinessDayDate
